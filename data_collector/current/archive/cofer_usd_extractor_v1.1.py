"""
COFER USD Reserve Share Explorer & Extractor v1.1
Last Updated: 2025-09-07 20:45 UTC
Explores IMF COFER dataset structure and extracts USD reserve share
"""
...
if __name__ == "__main__":
    ...
    csv_file = r"C:\Users\markf\OneDrive\Documents\GitHub\Humble-Conviction-Portfolio\data_collector\Historical Data\dataset_2025-09-07T20_18_24.972351557Z_DEFAULT_INTEGRATION_IMF.STA_COFER_7.0.0.csv"
    
    print("=" * 60)
    print("COFER USD Reserve Share Explorer & Extractor")
    print("=" * 60)
    ...
    if usd_row_index is not None:
        ...
        if cofer_data:
            ...
            print("\n" + "=" * 60)
            response = input("Save this data to master_data.json? (yes/no): ")
