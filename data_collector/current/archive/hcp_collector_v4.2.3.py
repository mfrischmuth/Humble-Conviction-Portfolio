#!/usr/bin/env python3
"""
HCP Unified Data Collector v4.2.3
File: hcp_unified_collector_v4.2.3.py
Last Updated: 2025-09-06 23:30:00 UTC
Compatible with: IPS v4.1, File Handler v2.1, Theme Calculator v3.2

MAJOR UPDATE v4.2.3: Path Corrections and Version Consistency
- Fixed paths to use GitHub repo location instead of Desktop
- Consistent v4.2.3 versioning throughout
- All functionality from v4.2.2 maintained
...
USAGE:
python hcp_unified_collector_v4.2.3.py --initialize    # First time setup
python hcp_unified_collector_v4.2.3.py --monthly       # Monthly update
python hcp_unified_collector_v4.2.3.py --import-csv [file]  # Import manual data
python hcp_unified_collector_v4.2.3.py --export-tracker     # Export for tracker
python hcp_unified_collector_v4.2.3.py --status        # Show current status
"""
...
logger = logging.getLogger('HCP_Unified_Collector_v4.2.3')


class HCPUnifiedCollector:
    """
    Unified collector v4.2.3 with correct GitHub repo paths
    """
    
    def __init__(self, mode='monthly'):
        """Initialize collector with v4.2.3 configuration"""
        self.mode = mode
        self.raw_data = {}
    ...
    def _save_master_data(self):
        ...
        self.master_data['metadata']['version'] = '4.2.3'
    ...
    def collect_all_data(self) -> Dict:
        ...
        logger.info("="*60)
        logger.info("HCP Unified Collector v4.2.3 - GitHub Repo Paths")
    ...
    def _export_manual_csv(self):
        ...
        print("   3. Save and run: python hcp_unified_collector_v4.2.3.py --import-csv " + csv_file.name)
    ...
    def show_status(self):
        ...
        print("\n" + "="*60)
        print("HCP DATA COLLECTOR STATUS - v4.2.3")
        print("="*60)
    ...
    def _save_output(self, output: Dict) -> str:
        ...
        filename = f"hcp_data_v423_{timestamp}.json"
    ...
    def _report_status(self):
        ...
        print("\n" + "="*60)
        print("COLLECTION COMPLETE - v4.2.3")
        print("="*60)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='HCP Unified Data Collector v4.2.3')
    ...
    print("="*60)
    print("HCP UNIFIED DATA COLLECTOR v4.2.3")
    print("GitHub Repository Paths Configured")
