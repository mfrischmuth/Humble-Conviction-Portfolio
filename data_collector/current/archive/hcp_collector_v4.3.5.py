...
Version: 4.3.5
IPS Version: 4.2
Filename: hcp_collector_v4_3_5.py
Last Updated: 2025-09-07T23:50:00 UTC

CHANGES IN v4.3.5:
- Fixed Put/Call collection - removed non-existent _scrape_cboe_website
- Proper file path handling for CBOE files
- Clean implementation without web scraping

ZERO REGRESSION POLICY: All v4.3.4 functionality preserved
"""
...
class Config:
    """Centralized configuration - v4.3.5"""
...
# ============================================================================
# DATA COLLECTOR v4.3.5
# ============================================================================

class HCPDataCollectorV435:
    """Data collector v4.3.5 - Fixed Put/Call collection"""
    ...
    # ========================================================================
    # FIXED Put/Call Collection - v4.3.5
    # ========================================================================
    
    def collect_put_call_ratio(self) -> bool:
        """
        Collect REAL Put/Call ratio data - v4.3.5 FIXED
        NO web scraping, only real files and Yahoo current
        """
        self.logger.info("📊 Collecting Put/Call Ratio (v4.3.5 FIXED)...")
        ...
        try:
            ...
            if cboe_file.exists():
                try:
                    ...
                    if date_col and pc_col:
                        ...
                        self.logger.warning(f"  ⚠ Could not identify columns. Found: {df.columns.tolist()}")
            ...
            if monthly_file.exists():
                ...
                self.logger.info("  ℹ No monthly CBOE file found (cboe_monthly_2020_2025.csv)")
    ...
    # ========================================================================
    # CORE COLLECTORS - UNCHANGED FROM v4.3.4
    # ========================================================================
    ...
    def collect_all_indicators(self) -> Dict[str, Any]:
        """Collect all indicators with v4.3.5 fixes"""
        self.logger.info("=" * 60)
        ...
        collectors = [
            ...
            ('Put/Call Ratio', self.collect_put_call_ratio),  # v4.3.5 FIXED
...
def main():
    """Main execution for v4.3.5"""
    print("\n" + "=" * 60)
    print("HCP Data Collector v4.3.5")
    print("FIXED Put/Call Collection")
    print("=" * 60 + "\n")
    
    # Create collector
    collector = HCPDataCollectorV435()
