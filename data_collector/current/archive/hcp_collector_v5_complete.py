...
Version: 5.0.0
Filename: hcp_collector_v5.0.0.py
Last Updated: 2025-09-09T00:00:00 UTC

MAJOR CHANGES IN v5.0:
- Non-destructive update architecture
- Multiple update modes (full, incremental, merge, latest, monthly)
- CSV import capability
- Smart data merging with validation
- Comprehensive backup system
- All 12 indicators with safety checks
"""
...
class HCPDataCollectorV5:
    """Data collector v5.0 with non-destructive updates and all 12 indicators"""
    ...
    def collect_put_call_ratio(self) -> bool:
        ...
        # For v5.0, preserve existing recovered data
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='HCP Data Collector v5.0 - Non-destructive updates'
    )
