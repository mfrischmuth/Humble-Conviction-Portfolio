/**
 * HCP Portfolio Tracker - Indicators Module v3.0
 * File: indicators_v3_0.js
 * Based on: IPS v4.2 Practical Implementation
 * Last Updated: 2025-09-07 23:00:00 UTC
 * 
 * CHANGES IN v3.0:
 * - Aligned with IPS v4.2 field names
 * - tech_employment_pct replaces rd_revenue
 * - trailing_pe replaces forward_pe
 * - All dataKey values match File Handler v3.1 output
 * - All other functionality PRESERVED from v2.1
 * 
 * HANDLES:
 * - 12 indicator definitions (3 per theme) per IPS v4.2
...
const Indicators = {
    ...
    // 12 Indicators per IPS v4.2 - ALIGNED WITH FILE HANDLER v3.1
    definitions: {
        usd: {
            dxy: { 
                name: 'DXY Index', 
                ...
                dataKey: 'dxy_index',  // IPS v4.2 field name
            ...
            realRate: { 
                ...
                dataKey: 'real_rate_differential',  // IPS v4.2 field name
            ...
            cofer: { 
                ...
                dataKey: 'cofer_usd',  // IPS v4.2 field name
        ...
        innovation: {
            qqqSpy: {
                ...
                dataKey: 'qqq_spy_ratio',  // IPS v4.2 field name
            ...
            productivity: { 
                ...
                dataKey: 'productivity_growth',  // IPS v4.2 field name
                source: 'BLS/FRED (OPHNFB)',
                frequency: 'quarterly',
                percentileWindow: 15,
                dataAvailableFrom: 1947
            },
            techEmployment: {  // UPDATED from rdRevenue
                name: 'Tech Employment % of Total',  // UPDATED per IPS v4.2
                temporal: 'lagging', 
                weight: 0.30,
                description: 'Information services employment / Total nonfarm',  // UPDATED
                dataKey: 'tech_employment_pct',  // IPS v4.2 field name
                source: 'FRED (USINFO / PAYEMS)',  // UPDATED
                frequency: 'monthly',  // UPDATED - better than quarterly
                percentileWindow: 15,
                dataAvailableFrom: 1990,
                note: 'Replaced R&D/Revenue in IPS v4.2 for better data availability'
            }
        },
        pe: {
            putCall: { 
                ...
                dataKey: 'put_call_ratio',  // IPS v4.2 field name
                source: 'CBOE (PCALL)',
                frequency: 'daily',
                percentileWindow: 15,
            ...
            trailingPe: {  // UPDATED from forwardPe
                name: 'S&P 500 Trailing P/E',  // UPDATED per IPS v4.2
                temporal: 'concurrent', 
                weight: 0.40,
                description: 'Trailing 12-month earnings multiple',  // UPDATED
                dataKey: 'trailing_pe',  // IPS v4.2 field name
                source: 'Yahoo Finance (SPY)',  // UPDATED
                frequency: 'daily',
                percentileWindow: 15,
                dataAvailableFrom: 1990,
            ...
            epsDelivery: { 
                ...
                dataKey: 'eps_delivery',  // IPS v4.2 field name
                source: 'FactSet',
                frequency: 'monthly',
                percentileWindow: 15,
                dataAvailableFrom: 1990
        ...
        usLeadership: {
            spyEfa: {
                ...
                dataKey: 'spy_efa_momentum',  // IPS v4.2 field name
                source: 'Yahoo Finance',
                frequency: 'daily',
                percentileWindow: 15,
            ...
            marketCapShare: { 
                ...
                dataKey: 'us_market_pct',  // IPS v4.2 field name
                source: 'Calculated from SPY/(SPY+EFA)',  // UPDATED per IPS v4.2
                frequency: 'daily',  // UPDATED
                percentileWindow: 15,
                dataAvailableFrom: 2001,  // UPDATED
            ...
            etfFlows: { 
                ...
                dataKey: 'etf_flow_differential',  // IPS v4.2 field name
                source: 'Volume proxy from Yahoo Finance',  // UPDATED per IPS v4.2
                frequency: 'daily',  // UPDATED
                percentileWindow: 15,
                dataAvailableFrom: 2003
            }
    ...
    // Temporal weights for aggregation - PRESERVED FROM v2.1
    temporalWeights: {
    ...
    // Validate configuration for IPS v4.2 compliance - UPDATED
    validateConfiguration: function() {
        const minData = this.getMinimumDataAvailability();
        console.log("Indicators v3.0 Configuration Validation");
        console.log("=" + "=".repeat(50));
        console.log(`  Framework: IPS v4.2 Practical Implementation`);
        ...
        console.log(`  Innovation: Tech Employment % (monthly updates)`);
        ...
        console.log(`  Aligned with File Handler v3.1 data structure`);
