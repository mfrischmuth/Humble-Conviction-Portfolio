/**
 * HCP Portfolio Tracker - Theme Calculator Module v2.0
 * File: theme_calculator_v2_0.js
 ...
 * 
 * REPLACES: theme_calculator_v1_0.js (sigmoid-based approach)
 */
...
const ThemeCalculator = {
    ...
    // IPS v3.9 Indicator Specifications with MA Comparisons
    indicatorSpecs: {
        ...
        // International Theme (3 indicators - reduced from 4 in v3.8)
        intl: {
            acwxSpy: {
                dataKey: 'acwxSpy',
    ...
    /**
     * Calculate theme probability using IPS v3.9 aggregation
     */
    calculateThemeProbability: function(themeIndicators, themeName) {
        ...
        Object.keys(indicatorSpecs).forEach(key => {
            ...
            const indicator = themeIndicators[spec.dataKey];
    ...
    calculateThemeAnalysis: function(monthlyData, indicators) {
        ...
        const themes = {
            ...
            ai: this.calculateThemeProbability(dataIndicators, 'ai'),
    ...
    /**
     * Display enhanced results with IPS v3.9 formatting
     */
    displayThemeResults: function(analysis, containerId) {
        ...
        Object.entries(analysis.themes).forEach(([key, probability]) => {
            ...
            const confidence = probability > 0.7 || probability < 0.3 ? 'high' : 
            ...
            html += `
                <div class="theme-item">
                    <div class="theme-header">
                        ...
                        <div class="confidence-badge confidence-${confidence}">${confidence}</div>
                    </div>
                    <div class="theme-bar">
    ...
    /**
     * Get color class for scenario probability
     */
    getScenarioColorClass: function(probability) {
        if (probability >= 0.15) return 'scenario-very-high';
        if (probability >= 0.10) return 'scenario-high';
        if (probability >= 0.07) return 'scenario-medium';
        if (probability >= 0.04) return 'scenario-low';
