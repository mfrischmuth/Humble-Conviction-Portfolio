/**
 * HCP Portfolio Tracker - Theme Calculator Module v2.6
 * File: theme_calculator_v2_6.js
 * Based on: IPS v3.9 Appendix H Mathematical Specifications
 * Last Updated: 2025-08-31 19:00:00 UTC
 * 
 * CRITICAL FIX IN v2.6:
 * - REMOVED problematic boundary conditions that forced uniform 30%/5% probabilities
 * - Allows IPS v3.9 methodology to properly express strong signals (70-85% for tech boom)
 * - Maintains all core three-component calculations without artificial caps
 * 
 * CHANGES IN v2.5:
 ...
 * 
 * HANDLES:
 * - IPS v3.9 compliant probability calculations (WITHOUT boundary condition overrides)
 ...
 * 
 * REPLACES: theme_calculator_v2_5.js (boundary conditions removed)
 */
...
const ThemeCalculator = {
    ...
    // IPS v3.9 Indicator Specifications - ALIGNED WITH FILEHANDLER v1.4
    indicatorSpecs: {
        ...
        // Innovation Theme (3 indicators) - ALIGNED WITH FILEHANDLER v1.4
        innovation: {
            productivity: {
        ...
        // International Theme (3 indicators) - ALIGNED WITH FILEHANDLER v1.4  
        intl: {
            acwxSpy: {
    ...
    /**
     * ENHANCED v2.6: Search indicator in FileHandler v1.4 nested structure
     */
     ...
     * v2.6 CRITICAL FIX: REMOVED boundary condition overrides that caused uniform 30%/5% probabilities
     */
    calculateEnhancedTransitionProbability: function(indicator, spec) {
        try {
            ...
            // REMOVED v2.6: Problematic boundary conditions that forced uniform 30%/5% probabilities
            // The following boundary condition overrides have been removed:
            // - Near trigger override (30% minimum when within 5% of MA)
            // - Far from trigger cap (20% maximum when beyond 30% from MA)
            // - Extreme momentum override (additional 20% for strong momentum)
            
            // Step 7: Apply IPS v3.9 bounds [0.05, 0.95] ONLY
    ...
    /**
     * FIXED v2.6: Calculate theme probability using correct data structure
     */
    calculateThemeProbability: function(dataIndicators, themeName) {
        ...
        Object.keys(indicatorSpecs).forEach(key => {
            ...
            // Use nested data lookup for FileHandler v1.4 structure
    ...
    calculateThemeAnalysis: function(monthlyData, indicators) {
        ...
        // Calculate theme probabilities using IPS v3.9 methodology (v2.6: boundary conditions removed)
        const themes = {
        ...
        return {
            methodology: 'IPS v3.9 Appendix H (v2.6: Boundary Conditions Removed)',
