/**
 * HCP Portfolio Tracker - Theme Calculator Module v4.0
 * Based on: IPS v4.2 Practical Implementation (Strict Compliance)
 * Last Updated: 2025-09-07 23:45:00 UTC
 * 
 * MAJOR UPDATE v4.0:
...
const ThemeCalculator = {
    ...
    validateConfiguration: function() {
        console.log("ThemeCalculator v4.0 Configuration Validation");
        ...
        console.log("  ✓ Let the data speak for itself");
...
if (typeof window !== 'undefined') {
    ...
    console.log("ThemeCalculator v4.0 loaded - IPS v4.2 Strict Compliance");
