/**
 * HCP Rebalancing Module v1.1 - Steps 6-7 Implementation
 * File: rebalancing_module_v1_1.js
 * Based on: IPS v4.3.2, Portfolio Optimizer v3.0 compatibility
 * Last Updated: 2025-09-08 19:00:00 UTC
 * 
 * CHANGES IN v1.1:
 * - Added IGF (Global Infrastructure) to security universe
 * - Corrected equity count from 5 to 6
 * - Corrected alternative count from 4 to 3
 * - Added IGF to display order array
 * 
...
const RebalancingModule = {
    ...
    lastUpdated: '2025-09-08T19:00:00.000Z',
    
    // IPS v4.3.2 Complete Security Universe (12 Assets)
    securities: {
        // Equity Exposures (6)
    ...
    // Trading Constraints (IPS v4.3.2 Specifications)
    constraints: {
    ...
    validatePositionInput: function(positionInputs, totalPortfolioValue) {
        console.log('=== RebalancingModule v1.1: Validating Position Input ===');
    ...
    calculateDrift: function(currentPositions, targetAllocation, totalPortfolioValue) {
        console.log('=== RebalancingModule v1.1: Calculating Portfolio Drift ===');
    ...
    generateTrades: function(driftAnalysis, options = {}) {
        console.log('=== RebalancingModule v1.1: Generating Rebalancing Trades ===');
    ...
    calculateShareQuantity: function(security, position) {
        ...
        const assumedPrices = {
            ...
            IGF: 60,  // Added IGF price assumption
            PIMIX: 100, PYLD: 50,
            GLD: 190, COM: 55, DBMF: 25,
            SWVXX: 1
        };
    ...
    displayPositionInputInterface: function(containerId, existingPositions = {}) {
        ...
        // Generate input rows for each security - UPDATED ORDER WITH IGF
        const securityOrder = ['VTI', 'VEA', 'VWO', 'SMH', 'SRVR', 'IGF', 'PIMIX', 'PYLD', 'GLD', 'COM', 'DBMF', 'SWVXX'];
...
console.log('RebalancingModule v1.1 loaded - Steps 6-7 Implementation ready with 12 assets');